...
const nameSongs = [
	...
	"YOU GOT IT", /*3*/
	"WATER & SAND", /*4*/
	"ANGEL STANDING AT MY DOOR", /*5*/
	"42", /*6*/
	"THE MORE THINGS CHANGE", /*7*/
	"GHOST TOWN", /*8*/
	"LET ME GO", /*9*/
	"GLIMMERS OF HOPE MP4", /*10*/
	"TRIBUNE", /*11*/
	"NO DOWNSIDE", /*12*/
	"CONTROL YOURSELF", /*13*/
	"FRIENDS", /*14*/
	"WHAT DO YOU WANT FROM ME?", /*15*/
	"FIELD OF PAIN", /*16*/
	"SHOULDERS OF GIANTS", /*17*/
	"SUPERMAN", /*18*/
	"NO REST FOR THE WEARY", /*19*/
	"SO LONG", /*20*/
]
